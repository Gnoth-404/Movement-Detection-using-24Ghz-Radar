...
#define WaveDAC8_DEFAULT_RANGE    (17u) /* Default DAC range */
...
#define WaveDAC8_DAC_RANGE      ((uint8)(17u << 2u) & WaveDAC8_RANGE_MASK)
#define WaveDAC8_DAC_POL        ((uint8)(17u >> 1u) & WaveDAC8_IDIR_MASK)
