...
// 
/**
 * Calculate the magnitude of fft , half of sample size 
 * \param <Format: copy of the parameter type and name - [IN OUT] description>
 * sint32_t *fft_buffer: number of samples
 *  uint16_t fft_length : number of reference
 * sint32_t *mag_square: number of guard
 *  sint32_t *power 
...
/**
 * Calculate threshhold and detected index based on CA- CFAR method
 * \param <Format: copy of the parameter type and name - [IN OUT] description>
 * N: number of samples
 * NR : number of reference
 * NG: number of guard
 * abs_fft_input 
 * detection output array
