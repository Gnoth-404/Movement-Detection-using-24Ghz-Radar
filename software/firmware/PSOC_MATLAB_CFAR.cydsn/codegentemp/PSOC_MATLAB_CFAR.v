// ======================================================================
// PSOC_MATLAB_CFAR.v generated from TopDesign.cysch
// 07/05/2024 at 10:12
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8218bc72-7fd5-4f3f-bebe-b580385b986c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a9d73264-b7f4-4d5c-94da-1db8dcea36d7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_3 UART_LOG (
        ...
        .rx_clk(Net_249),
        .rx_data(Net_250),
        .rx_interrupt(Net_251),
        .tx(Net_203),
        .tx_clk(Net_252),
        .tx_data(Net_253),
        .tx_en(Net_254),
        .tx_interrupt(Net_255));
	...
	cy_psoc3_pins_v1_10
		#(.id("7f62504b-ffd3-4a81-8651-a1ddc0227a28"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("71f6a296-53cd-441b-9ae8-4cfc8db3ac58"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
